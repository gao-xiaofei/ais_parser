...
*/
#ifndef _AIS_VDM_PARSE_H_
#define _AIS_VDM_PARSE_H_
...
typedef struct {
  ...
  int _true;             //!< 9 bits  : _True heading
...
typedef struct {
  ...
  char report_interval;  //!< 4 bits   : Reporting Interval from IEC 62287 Table
                         //!< 17
...
typedef struct {
  ...
  int cog;    //!< 9 bits  : Course over Ground,0 to 359 degrees, 511 = not
              //!< available.
  char gnss;  //!< 1 bit   : GNSS Position status,0 = current GNSS position 1 =
