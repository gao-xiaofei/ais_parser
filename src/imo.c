...
/*! \file
   ...
   Reserved \version 1.0
    ...
    Includes information like Meteorological and Hydrological data, Dangerous
   Cargo Indication, etc.
...
int parse_imo1_12(sixbit *state, imo1_12 *result) {
  ...
  if (get_timetag(state, &result->atd)) return 3;
  ...
  if (get_timetag(state, &result->eta)) return 3;
