...
*/
/* ----------------------------------------------------------------------- */
sixbit *get_msg6_data(aismsg_6 *msg) { return &msg->data; }
...
*/
/* ----------------------------------------------------------------------- */
sixbit *get_msg8_data(aismsg_8 *msg) { return &msg->data; }
...
*/
/* ----------------------------------------------------------------------- */
sixbit *get_msg17_data(aismsg_17 *msg) { return &msg->data; }
...
*/
/* ----------------------------------------------------------------------- */
timetag *get_weather_utc_time(weather_report *msg) { return &msg->utc_time; }
...
*/
/* ----------------------------------------------------------------------- */
timetag *get_wind_utc_time(wind_report *msg) { return &msg->utc_time; }
...
*/
/* ----------------------------------------------------------------------- */
timetag *get_lock_schedule_utc_time(seaway2_1 *msg) { return &msg->utc_time; }
...
*/
/* ----------------------------------------------------------------------- */
timetag *get_lock_schedule_eta(lock_schedule *msg) { return &msg->eta; }
...
*/
/* ----------------------------------------------------------------------- */
timetag *get_lock_times_utc_time(seaway2_2 *msg) { return &msg->utc_time; }
...
*/
/* ----------------------------------------------------------------------- */
timetag *get_lock_times_last_ata(seaway2_2 *msg) { return &msg->last_ata; }
...
*/
/* ----------------------------------------------------------------------- */
timetag *get_lock_times_first_eta(seaway2_2 *msg) { return &msg->first_eta; }
...
*/
/* ----------------------------------------------------------------------- */
timetag *get_lock_times_second_eta(seaway2_2 *msg) { return &msg->second_eta; }
...
*/
/* ----------------------------------------------------------------------- */
timetag *get_current_utc_time(current_report *msg) { return &msg->utc_time; }
...
*/
/* ----------------------------------------------------------------------- */
timetag *get_salinity_utc_time(salinity_report *msg) { return &msg->utc_time; }
...
*/
/* ----------------------------------------------------------------------- */
timetag *get_procession_order_utc_time(pawss2_3 *msg) { return &msg->utc_time; }
...
*/
/* ----------------------------------------------------------------------- */
timetag *get_imo1_12_atd(imo1_12 *msg) { return &msg->atd; }
...
*/
/* ----------------------------------------------------------------------- */
timetag *get_imo1_12_eta(imo1_12 *msg) { return &msg->eta; }
